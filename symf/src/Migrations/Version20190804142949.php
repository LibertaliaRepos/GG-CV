 ...
 */
final class Version20190804142949 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xppro CHANGE contract_type_id contract_type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xppro CHANGE contract_type_id contract_type_id INT NOT NULL');
    }
}
