 ...
 */
final class Version20181028140154 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE phone ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_phone contact_id INT NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE phone MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE phone DROP FOREIGN KEY FK_444F97DDE7A1254A');
        $this->addSql('DROP INDEX UNIQ_444F97DDE7A1254A ON phone');
        $this->addSql('ALTER TABLE phone DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE phone DROP id, CHANGE contact_id id_phone INT NOT NULL');
    }
}
